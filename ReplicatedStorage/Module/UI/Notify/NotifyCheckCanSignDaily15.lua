...
local NotifyCheckCanSignDaily15 = {}

function NotifyCheckCanSignDaily15:Handle(rootPart)
	local notifyPart = rootPart:WaitForChild("Notify")
	local function refresh()
		NetClient:Request("Sign", "CheckCanSignDaily", { Key = "SignDaily15" } , function(result)
...
return NotifyCheckCanSignDaily15
